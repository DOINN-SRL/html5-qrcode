...
class TorchController {
  ...
  private updateUiBasedOnLatestSettings(
    ...
    if (isTorchOn === isTorchOnExpected) {
      ...
      this.buttonController.setText(
        isTorchOnExpected
          ? this.getTranslation("torchOffButton")
          : this.getTranslation("torchOnButton")
      );
  ...
  private propagateFailure(isTorchOnExpected: boolean, error?: any) {
    let errorMessage = isTorchOnExpected
      ? this.getTranslation("torchOnFailedMessage")
      : this.getTranslation("torchOffFailedMessage");
    if (error) {
...
export class TorchButton implements TorchButtonController {
  ...
  private constructor(
    ...
    this.onTorchActionFailureCallback = onTorchActionFailureCallback;
    this.torchButton = BaseUiElementFactory.createElement<HTMLButtonElement>(
      "button",
  ...
  private render(
    ...
    this.torchButton.innerText = this.getTranslation("torchOnButton");
