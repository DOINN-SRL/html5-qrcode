...
export class CameraZoomUi {
  ...
  private constructor(getTranslation: (key: string) => string) {
  ...
  private render(parentElement: HTMLElement, renderOnCreate: boolean) {
    ...
    let zoomString = this.getTranslation("zoom");
  ...
  public static create(
    ...
    let cameraZoomUi = new CameraZoomUi(getTranslation);
